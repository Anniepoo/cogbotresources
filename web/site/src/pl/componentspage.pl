...
%      components
%
pages:wizard_page_title(components, 'Select Components').
pages:wizard_page_content(components, pages:components_page_content).

pages:wizard_page_actions(components, [\wizard_button_default(componentsselected, 'Install The Selected Components')]).
